...
class OpenEQADataset(GradSLAMDataset):
    def __init__(
        self,
        config_dict,
        basedir,
        ...
        **kwargs,
        ...
        self.input_folder = os.path.join(basedir, sequence)
        print(basedir, sequence, self.input_folder)
        self.pose_path = os.path.join(self.input_folder, "traj.txt")
        super().__init__(
            config_dict,
            stride=stride,
...
def get_dataset(dataconfig, basedir, sequence, **kwargs):
    ...
    elif config_dict['dataset_name'].lower() in ['openeqa']:
        return OpenEQADataset(config_dict, basedir, sequence, **kwargs)
    else:
